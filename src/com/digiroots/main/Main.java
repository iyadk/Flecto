...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Flecto");

        jLabel2.setText("2D <-> 3D");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //new LoadProject(this).setVisible(true);
        JFileChooser fc = new JFileChooser();
        fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
        fc.setCurrentDirectory(new File("c:\\OrigamiProjects"));
        int returnVal = fc.showOpenDialog(this);
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            File file = fc.getSelectedFile();
            ProjectDesc project = ProjectDesc.loadProject(file.getPath());
            setProject(project);
    ...
    ProjectDesc project;
    public void setProject(ProjectDesc project){
        this.project = project;
        System.out.println(this.project);
        //Open OrigamiSShapeEditor and hide me
        ProjectFrame projectSettingFrame = new ProjectFrame(this,project);
        projectSettingFrame.setVisible(true);
